...
ln -sv $WEST_SIM_ROOT/common_files/Nnolog1.prmtop .
...
$PMEMD -O -i md.in -p Nnolog1.prmtop -c parent.rst -r seg.rst -x seg.nc -o seg.log -inf seg.nfo

COMMAND="         parm $WEST_SIM_ROOT/common_files/Nnolog1.prmtop\n" 
